    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-gray-200 dark:border-gray-700">
          ...
          <p className="text-3xl font-bold mb-1">{stats.profileViews.toLocaleString()}</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-gray-200 dark:border-gray-700">
          ...
          <p className="text-3xl font-bold mb-1">{stats.inquiries}</p>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 border-2 border-yellow-400 rounded-lg p-6 mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-xl font-bold mb-2">Featured Tier - $1,500/month</h3>
      ...
      <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            {recentInquiries.map((inquiry) => (
              <div key={inquiry.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  <p className="font-semibold">{inquiry.student}</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-3">
            ...
            <button className="w-full border-2 border-gray-300 dark:border-gray-600 py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
      ...
      <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-300 dark:border-blue-700 rounded-lg p-6 text-center">
        <h3 className="font-bold text-lg mb-2">🎓 University Partner Demo</h3>
        <p className="text-gray-600 dark:text-gray-400">
